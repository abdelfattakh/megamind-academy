...
class ReviewPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(Admin $admin, Review $review)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(Admin $admin, Review $review)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(Admin $admin, Review $review)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(Admin $admin, Review $review)
    {
